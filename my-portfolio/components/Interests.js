...
import {
  ...
  FaBook, FaGraduateCap, FaPen, FaMusic, FaCode
} from 'react-icons/fa';
const iconMap = {
...
const Interests = () => {
 ...
 const interestsData = [
  ...
  { title: 'Reading', description: 'Immersing myself in the world of books.', index: 8 },
  { title: 'Learning', description: 'Continuously expanding my horizons.', index: 9 },
  { title: 'Writing', description: 'Expressing my thoughts and ideas through the written word.', index: 10 },
  { title: 'Flute', description: 'Exploring the beauty of music through the flute.', index: 11 }
];
